...
public class PagoControl {
    ...
    public HashMap<String, Object> request(float total, String currency) throws IOException {
        ...
        String data = ""
                ...
                + "&paymentType=CD"
                + "&integrity=true"
                + "&shopperResultUrl=http://localhost:8080/pago-list";
    ...
    public HashMap<String, Object> readJsonCheckout(String jsonValue) {
        ...
        if (new Utiles().constanceArray(CODE, codigo)) {
            ...
            System.out.println("JSON recibido de OPPWA (checkout): " + jsonValue);
    ...
    public HashMap<String, Object> readJsonPay(String jsonValue) {
        HashMap<String, Object> respMap = new HashMap<>();
        Gson g = new Gson();
        HashMap mapa = g.fromJson(jsonValue, HashMap.class);
        mapa.forEach((key, value) -> System.out.println(key + " " + value));
    ...
    public HashMap<String, Object> requestPay(String id) throws IOException {
        URL url = new URL(
