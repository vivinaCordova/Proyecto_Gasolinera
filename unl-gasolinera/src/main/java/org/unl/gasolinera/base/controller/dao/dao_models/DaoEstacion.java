...
public class DaoEstacion extends AdapterDao<Estacion> {
    ...
    private HashMap<String, Object> toDict(Estacion estacion, Integer i) throws Exception {
        HashMap<String, Object> aux = new HashMap<>();
        DaoEstacion de= new DaoEstacion();
        aux.put("id", estacion.getId().toString(i));
        aux.put("codigo", estacion.getCodigo());
        aux.put("estado", estacion.getEstadoE().toString());
        return aux;
